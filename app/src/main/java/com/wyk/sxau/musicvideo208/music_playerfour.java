...
public class music_playerfour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_musicfour);
...
//监听滚动条事件
        ...
        preButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.stop();
                Intent intent1=new Intent(music_playerfour.this,music_playersix.class);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.stop();
                Intent intent2=new Intent(music_playerfour.this,music_playertwo.class);
        ...
        downButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3=new Intent(music_playerfour.this,music_main.class);
    ...
    private void play() {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.kunkun);
        ...
        // 创建一个线程
        thread = new Thread(new music_playerfour.MuiscThread());
        // 启动线程
        thread.start();
