...
public class music_playertwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_musictwo);
...
//监听滚动条事件
        ...
        preButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.stop();
                Intent intent1=new Intent(music_playertwo.this,music_playersix.class);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.stop();
                Intent intent2=new Intent(music_playertwo.this,music_playertwo.class);
        ...
        downButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3=new Intent(music_playertwo.this,music_main.class);
    ...
    private void play() {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.fanfan);
        ...
        // 创建一个线程
        thread = new Thread(new music_playertwo.MuiscThread());
        // 启动线程
        thread.start();
